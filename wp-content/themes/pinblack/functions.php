 ...
 * Title filter 
 */
function pinblack_filter_wp_title( $title ) {
    // Get the Site Name
...
// Hook into 'wp_title'
add_filter( 'wp_title', 'pinblack_filter_wp_title' );
...
function pinblack_posted_on() {
	printf( __( '<span class="sep">Posted on </span><a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a><span class="byline"> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>', 'pinblack' ),
...
function pinblack_scripts_custom() {
    ...
    wp_enqueue_script( 'custom', get_template_directory_uri() . '/library/js/scripts.js', array( 'jquery', 'masonry' ), '1.0.0', true );
}    
